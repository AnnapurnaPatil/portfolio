...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/annapurnapatil.png?v=1", sizes: "32x32", type: "image/png" },
      { url: "/annapurnapatil.png?v=1", sizes: "16x16", type: "image/png" },
    ],
    apple: [
      { url: "/annapurnapatil.png?v=1", sizes: "180x180", type: "image/png" },
    ],
    other: [
      {
        rel: "mask-icon",
